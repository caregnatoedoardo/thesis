...
\begin{itemize}
	...
	\item Funzionalità \textbf{Hyper-V} abilitata da Windows \footcite{Per abilitare il supporto di virtualizzazione Hyper-V su Windows bastera' accedere all'apposito menu "Abilita o disabilita funzionalità di Windows" e selezionare la voce "Hyper-V"}.
\end{itemize}
