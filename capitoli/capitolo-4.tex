...
L'esposizione delle Docker API sono di \textbf{vitale importanza} per l'esecuzione dello script Powershell "\textbf{nginxREscript.ps1}", e la porta precedentemente esposta andrà opportunamente manualmente manualmente anche all'interno dello stesso script.\\
